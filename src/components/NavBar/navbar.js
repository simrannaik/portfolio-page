    ...
    return(
        <nav className="navbar">
            ...
            <div className="desktopMenu">
                ...
                <Link activeClass="active" to="certi" spy={true} smooth={true} offset={-60} duration={500} className="desktopMenuListItem">Certifications</Link>
            </div>
            ...
            <div className="navMenu" style={{display: showMenu? 'flex':'none'}}>
                ...
                <Link activeClass="active" to="certi" spy={true} smooth={true} offset={-50} duration={500} className="listItem" onClick={()=>setShowMenu(false)}>Certifications</Link>
